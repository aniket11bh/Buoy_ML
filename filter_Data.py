...
datafile = open("Data/filtered_red_data.txt",'r')
data = []
lines = datafile.readlines()
for line in lines:
    data.append([int(x) for x in line.split()])
datafile.close()
data1 = remove_redundant(data)
data1 = filter_data(data1)

datafile = open("Data/filtered_water_data.txt",'r')
data = []
lines = datafile.readlines()
for line in lines:
    data.append([int(x) for x in line.split()])
...
# filtered_data_file = open("Data/filtered_yellow_data.txt",'w')
# for datapoint in data:
